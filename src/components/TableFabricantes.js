...
export default function CustomizedTables() {
    ...
    const getFetch = async () => {
        ...
        const promise = await fetch("http://localhost:8080/ExtraMike/api/cliente/puntoUno/", {
            method: 'GET',
    ...
    return (
        <>
            <div style={{marginTop: 40, marginLeft: 40, marginBottom: 25}}><h2>PUNTO 1 : Devuelve un listado que muestre solamente los clientes que no han realizado
                ningún pago.</h2></div>
