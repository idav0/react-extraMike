...
export default function CustomizedTables() {
    ...
    const getFetch = async () => {
        ...
        const promise = await fetch("http://localhost:8080/ExtraMike/api/cliente/puntoTres/", {
            method: 'GET',
    ...
    return (
        <>
            ...
            <div style={{marginTop : 40, marginLeft : 40, marginBottom : 25}}><h2>PUNTO 3 : Devuelve un listado que muestre los clientes que no han realizado ningún
                pago y los que no han realizado ningún pedido.</h2></div>
                ...
                <TableBody>
                    {data.map((row) => (
                        <StyledTableRow key={row}>
                            ...
                            <StyledTableCell component="th" scope="row">{row.codigo_empleado_rep_ventas}</StyledTableCell>
